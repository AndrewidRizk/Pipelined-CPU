# Given a null-terminated array of words at address 0x18,
# the program computes the sum and the OR of all its elements
# and stores them at addresses 0x20 and 0x24, respectively.
